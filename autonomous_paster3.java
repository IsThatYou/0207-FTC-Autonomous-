...
public class autonomous_paster3 extends OpMode

{
    ...
    DcMotor v_motor_left_drive_1;
    DcMotor v_motor_left_drive;
    DcMotor v_motor_right_drive;
    DcMotor v_motor_right_drive_1;
    DcMotorController wheels1;
    DcMotorController wheels2;
...

    {
        ...
        //DcMotorController.setMotorControllerDeviceMode(DcMotorController.DeviceMode.READ_ONLY);
        wheels1 = hardwareMap.dcMotorController.get("wheels");
        wheels2 = hardwareMap.dcMotorController.get("wheels2");
        wheels1.setMotorControllerDeviceMode(DcMotorController.DeviceMode.READ_ONLY);
        wheels2.setMotorControllerDeviceMode(DcMotorController.DeviceMode.READ_ONLY);
        ...
        try
        {
            ...
            v_motor_left_drive_1 = hardwareMap.dcMotor.get ("motor_3");
        }
        catch (Exception p_exeception)
        {
            ...
            v_motor_left_drive_1 = null;
        }

        try
        {
            v_motor_right_drive = hardwareMap.dcMotor.get ("motor_2");
            v_motor_right_drive_1 = hardwareMap.dcMotor.get ("motor_4");
            v_motor_right_drive.setDirection (DcMotor.Direction.REVERSE);
            v_motor_right_drive_1.setDirection (DcMotor.Direction.REVERSE);
        }
        catch (Exception p_exeception)
        {
    ...
    double a_left_drive_power ()
    {
        ...
        {
            wheels1.setMotorControllerDeviceMode(DcMotorController.DeviceMode.READ_ONLY);wheels2.setMotorControllerDeviceMode(DcMotorController.DeviceMode.READ_ONLY);
    ...
    double a_left_drive_power_1 ()
    {
        double l_return = 0.1;

        if (v_motor_left_drive_1 != null)
        {
            wheels1.setMotorControllerDeviceMode(DcMotorController.DeviceMode.READ_ONLY);wheels2.setMotorControllerDeviceMode(DcMotorController.DeviceMode.READ_ONLY);
            l_return = v_motor_left_drive_1.getPower ();
        }
    ...
    double a_right_drive_power_1 ()
    {
        double l_return = 0.1;

        if (v_motor_right_drive_1 != null)
        {
            wheels1.setMotorControllerDeviceMode(DcMotorController.DeviceMode.READ_ONLY);wheels2.setMotorControllerDeviceMode(DcMotorController.DeviceMode.READ_ONLY);
            l_return = v_motor_right_drive_1.getPower ();
        }
    ...
    {
        if (v_motor_left_drive != null && v_motor_left_drive_1 != null)
        {
            wheels1.setMotorControllerDeviceMode(DcMotorController.DeviceMode.WRITE_ONLY);wheels2.setMotorControllerDeviceMode(DcMotorController.DeviceMode.WRITE_ONLY);

            v_motor_left_drive.setPower (p_left_power);
            v_motor_left_drive_1.setPower (p_left_power);
        }
        if (v_motor_right_drive != null && v_motor_right_drive_1 != null)
        {
            wheels1.setMotorControllerDeviceMode(DcMotorController.DeviceMode.WRITE_ONLY);wheels2.setMotorControllerDeviceMode(DcMotorController.DeviceMode.WRITE_ONLY);
            v_motor_right_drive.setPower(p_right_power);
            v_motor_right_drive_1.setPower(p_right_power);
        }
...

    {
        if (v_motor_left_drive != null && v_motor_left_drive_1 != null)
        {
            telemetry.addData("98", "run using encoder:" + v_motor_left_drive.getCurrentPosition ());
            wheels1.setMotorControllerDeviceMode(DcMotorController.DeviceMode.WRITE_ONLY);wheels2.setMotorControllerDeviceMode(DcMotorController.DeviceMode.WRITE_ONLY);
            v_motor_left_drive.setMode
                    (DcMotorController.RunMode.RUN_USING_ENCODERS
                    );
            wheels1.setMotorControllerDeviceMode(DcMotorController.DeviceMode.WRITE_ONLY);wheels2.setMotorControllerDeviceMode(DcMotorController.DeviceMode.WRITE_ONLY);
            v_motor_left_drive_1.setMode
                    (DcMotorController.RunMode.RUN_USING_ENCODERS
                    );
        }
...

    {
        ...
        {
            wheels1.setMotorControllerDeviceMode(DcMotorController.DeviceMode.READ_ONLY);wheels2.setMotorControllerDeviceMode(DcMotorController.DeviceMode.READ_ONLY);
            DcMotorController.RunMode a = v_motor_left_drive.getMode ();
            DcMotorController.RunMode b = v_motor_left_drive_1.getMode ();
            wheels1.setMotorControllerDeviceMode(DcMotorController.DeviceMode.WRITE_ONLY);wheels2.setMotorControllerDeviceMode(DcMotorController.DeviceMode.WRITE_ONLY);
            if (a ==
                    DcMotorController.RunMode.RESET_ENCODERS && b ==
...

    {
        if (v_motor_left_drive != null && v_motor_left_drive_1 != null)
        {
            ...
            if (wheels2.getMotorControllerDeviceMode()==DcMotorController.DeviceMode.WRITE_ONLY && wheels1.getMotorControllerDeviceMode()==DcMotorController.DeviceMode.WRITE_ONLY) {
                ...
                wheels1.setMotorControllerDeviceMode(DcMotorController.DeviceMode.WRITE_ONLY);
                wheels2.setMotorControllerDeviceMode(DcMotorController.DeviceMode.WRITE_ONLY);
                v_motor_left_drive_1.setMode
                        (DcMotorController.RunMode.RESET_ENCODERS
                        );
            }
...

    {
        ...
        if (v_motor_left_drive != null && v_motor_left_drive_1 != null)
        {
            ...
            //
            wheels1.setMotorControllerDeviceMode(DcMotorController.DeviceMode.READ_ONLY);wheels2.setMotorControllerDeviceMode(DcMotorController.DeviceMode.READ_ONLY);
            telemetry.addData("99", "left drive encoder:" + v_motor_left_drive.getCurrentPosition ());
            telemetry.addData("100", "left drive 1 encoder:" + v_motor_left_drive_1.getCurrentPosition ());
